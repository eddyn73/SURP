...
callFunction.f___archivamiento_archivar=function(objeto)
{
    var p__idPaciente= $(objeto).closest('tr').attr('p__idPaciente');
    ...
    $.post(callFunction.f__rutaModulo(),callFunction.f__encriptar(
     '&p__m=e__archivamiento'
    +'&p__i=e__controller'
    +'&p__function=e__archivar'
    +'&p__typeResponse=e__json'
    //+'&p__credencial='+$('#p__credencialAprobarEvacuacion').val()
    +'&p__idPaciente='+p__idPaciente 
    )
    ,function(data)
    {
